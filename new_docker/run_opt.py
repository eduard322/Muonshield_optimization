...
else:        import optDet_conf as shipDet_conf
...
#fieldMaker.plotField(1, ROOT.TVector3(-7000.0, -3000.0, 10.0), ROOT.TVector3(-300.0, 300.0, 6.0), 'Bzx.png')
#fieldMaker.plotField(2, ROOT.TVector3(-7000.0, -3000.0, 10.0), ROOT.TVector3(-400.0, 400.0, 6.0), 'Bzy.png')
